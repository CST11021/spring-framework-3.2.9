...
public class ComponentScanBeanDefinitionParser implements BeanDefinitionParser {
	...
	//
	// 这样的声明未免太不优雅，而Spring为我们提供了一种极为方便注册这些BeanPostProcessor的方式，即使用<context:annotation- config/>隐式地向
	// Spring容器注册AutowiredAnnotationBeanPostProcessor、RequiredAnnotationBeanPostProcessor、
	// CommonAnnotationBeanPostProcessor以及PersistenceAnnotationBeanPostProcessor这4个BeanPostProcessor。配置如下：
	...
	/**
	 * 解析节点<context:component-scan/> 配置节点
	 *
	 * @param element		表示 <context:component-scan/> 配置节点
	 * @param parserContext
	 * @return
	 */
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		...
		// build ClassPathBeanDefinitionScanner
